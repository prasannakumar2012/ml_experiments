...
def main():
    ...
    df_train = pd.read_csv('/Volumes/Abhishek/Quora/train_features.csv', encoding="ISO-8859-1")
    ...
    df_train = pd.read_csv('/Volumes/Abhishek/quora_ques/train.csv')
    df_train = df_train.fillna(' ')

    df_test = pd.read_csv('/Volumes/Abhishek/quora_ques/test.csv')
    ...
    df_test = pd.read_csv('/Volumes/Abhishek/Quora/test_features.csv', encoding="ISO-8859-1")
    ...
    sub.to_csv('rand_' + args.save + '.csv')
